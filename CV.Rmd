...
info <- data.frame(col1 = c("Date of birth",
                   ...
                   col2 = c("September 10, 1996",
                            ...
                            "+31 627611760"))
colnames(info) <- NULL
pander::pandoc.table(info, split.table = Inf, split.cells = 100, justify = "left")
```
...
```{r , echo = FALSE, results = "asis"}
WVOF <- data.frame(col1 = c("2013 - 2022",
                            "2016 - 2019",
                            "2015 & 2018",
                            "2016 - 2018"),
                   ...
                   col3 = c("",
                            ...
                            ""))
colnames(WVOF) <- NULL
pander::pandoc.table(WVOF, split.table = Inf, split.cells = 100, justify = "left")
```
